# Chat AI API
This is the backend for the Chat AI application. It is a Node/Express/TypeScript API that uses [Stream](https://getstream.io/) for chat, chat history, and user management. It also uses a PostgreSQL database from [Neon](https://neon.tech/) to store user information and chat history. We use the [Drizzle ORM](https://orm.drizzle.team/) to interact with the database. Open AI is used for the AI chatbot.

The Vue.js frontend for this application can be found [here](https://github.com/HarryLinux/chat-ai-ui).
